...
std::string giga::Result::to_string(bool is_tsv) {
	...
	buffer << std::setw(pad) << "trial" << sep << std::setw(3) << "tag" << sep << std::setw(pad) << "tput (B/us)" << sep << std::setw(pad) << "lat (B)" << sep << std::setw(pad) << "file (B)" << sep << std::setw(pad) << "cache" << sep << std::setw(pad) << "page (B)" << sep << std::setw(pad) << "n_clients" << std::endl;
	...
	for(size_t index = 0; index < this->get_size(); ++index) {
		...
		buffer << std::setw(pad) << index + 1 << sep << std::setw(3) << this->get_tag(index) << sep << std::setw(pad) << this->get_throughput(index) << sep << std::setw(pad) << this->get_latency(index) << sep << std::setw(pad) << this->get_file_size(index) << sep << std::setw(pad) << this->get_cache_size(index) << sep << std::setw(pad) << this->get_page_size(index) << sep << std::setw(pad) << this->get_n_clients(index) << std::endl;
	}
