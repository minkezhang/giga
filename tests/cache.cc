...
TEST_CASE("giga|cache-sanity") {
	...
	REQUIRE_NOTHROW(t.correctness(l, 10000, false));
	REQUIRE_NOTHROW(t.performance("SAN", l, line_size, access_pattern, access_pattern_aux, .5, 10000, false));
}
